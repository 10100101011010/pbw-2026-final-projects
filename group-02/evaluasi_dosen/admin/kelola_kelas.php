...
if (isset($_POST['tambah'])) {
    ...
    mysqli_query($conn, "INSERT INTO kelas (nama, semester, tahun_akademik) VALUES ('$nama', '$semester', '$tahun')");
...
if (isset($_POST['edit'])) {
    ...
    $semester = $_POST['semester'];
    $tahun = $_POST['tahun_akademik'];
    mysqli_query($conn, "UPDATE kelas SET nama='$nama', semester='$semester', tahun_akademik='$tahun' WHERE id=$id");
    header("Location: kelola_kelas.php");
    exit();
}
...
$data = mysqli_query($conn, "SELECT * FROM kelas ORDER BY nama");
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    ...
    <div class="wrapper">
        <div class="page-title">
            <h2> Kelola Kelas</h2>
            <p>Tambah, edit, atau hapus data kelas</p>
        </div>

        <div class="form-box" style="margin-bottom: 30px;">
            <h3 style="color:#4A154B; margin-bottom:15px;">➕ Tambah Kelas Baru</h3>
            <form method="POST" class="form-inline">
                <input type="text" name="nama" placeholder="Nama Kelas (contoh: 1A)" required>
                <select name="semester" required>
                    <option value="Ganjil">Ganjil</option>
                    <option value="Genap">Genap</option>
                </select>
                <input type="text" name="tahun_akademik" placeholder="Tahun (contoh: 2025/2026)" required>
    ...
    <?php if (isset($_GET['edit'])): 
        $id = $_GET['edit'];
        $edit = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM kelas WHERE id=$id"));
    ?>
    <div class="modal">
        <div class="modal-content">
            <span class="close" onclick="window.location='kelola_kelas.php'">&times;</span>
            <h3> Edit Kelas</h3>
            <form method="POST">
                ...
                <input type="text" name="tahun_akademik" value="<?= $edit['tahun_akademik'] ?>" required>
